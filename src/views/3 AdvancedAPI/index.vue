<script setup lang="ts">
  ...
  import CustomRef from './CustomRef/index.vue';
  ...
  const anchor = (targetId: String) => {
    const id = targetId ? `md_3_${targetId}` : 'md_3_1';
...
<template>
  <Marked id="md_3_1" :content="MD.MD_3_1" />
  <CustomRef />
  <Marked id="md_3_2" :content="MD.MD_3_2" />
  <!-- <SetupSyntacticSugar /> -->
  <Marked id="md_3_3" :content="MD.MD_3_3" />
  <!-- <Ref /> -->
</template>